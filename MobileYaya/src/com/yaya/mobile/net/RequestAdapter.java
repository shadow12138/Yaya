...
public abstract class RequestAdapter implements Serializable {
	...
	public RequestAdapter() {
		...
		setHost(com.yaya.mobile.Config.getServerHost());
		setUrl("");
		setTimeOutLimit(30);
	...
	/*
	 * final private CallMethod setCallMethod() { return mCallMethod; }
	 */
	...
	final public RequestAdapter setDownLoadDir() {
		mLocalDir = com.yaya.mobile.Config.getLocalDir("download/");
		setLocalPath(getLocalDir() + getFileName());
		return this;
	}
	...
	final private void setCallMethod(CallMethod mothod) {
		...
		if (mCallMethod == CallMethod.eUnity) {
			mUnityUrl = com.yaya.mobile.Config.getServerHost();
		} else {
			mUnityUrl = null;
		}
	}

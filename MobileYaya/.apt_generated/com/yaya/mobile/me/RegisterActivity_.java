    ...
    implements HasViews, OnViewChangedListener
{
    ...
    public void onViewChanged(HasViews hasViews) {
        et_confirm = ((EditText) hasViews.findViewById(id.et_confirm));
        et_psw = ((EditText) hasViews.findViewById(id.et_psw));
        tv_code = ((TextView) hasViews.findViewById(id.tv_code));
        et_code = ((EditText) hasViews.findViewById(id.et_code));
        et_phone = ((EditText) hasViews.findViewById(id.et_mobile));
        et_username = ((EditText) hasViews.findViewById(id.et_username));
        progress = ((View) hasViews.findViewById(id.pb));
        {
            View view = hasViews.findViewById(id.tv_login);
            if (view!= null) {
        ...
        {
            View view = hasViews.findViewById(id.tv_code);
            if (view!= null) {
                view.setOnClickListener(new OnClickListener() {
                    ...
                    @Override
                    public void onClick(View view) {
                        RegisterActivity_.this.getCode();
                    }
